...
o: open file in another program
o: open file in another program in background
...
Y: mark all for copy
M: mark all for move
R: mark all for remove
Z: mark all for shred
D: mark all for trash (~/.local/share/fff/trash/)
S: mark all for symbolic link
B: mark all for bulk rename

p: paste/move/remove/shred/delete/bulk_rename
